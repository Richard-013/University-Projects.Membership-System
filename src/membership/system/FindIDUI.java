 ...
 * @author hortonr6
 */
public class FindIDUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindIDUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
